...
time.sleep(2)
slow_print(textwrap.dedent("""
			'Huh!? Where am I?'... it's pitch dark (not particulary surprising for a basement), damp
			(also not surprising), and strangely slippery. Feels like something slimy is crawling up your legs...
			"""), 0.05)
time.sleep(1)
...
if dagger == 1:
	...
	while True:
		...
		if choice_room_4 == "1." or choice_room_4 == "1" or choice_room_4 == "Attack" or choice_room_4 == "1. Attack" or choice_room_4 == "1.Attack":
			...
			slow_print(textwrap.dedent(f"""
			You slowly back up from the {enemy_room_1['name']} and quietly leave the scene. You find yourself in front of a big tree, probably the oldest tree in the forest. The tree speaks:
